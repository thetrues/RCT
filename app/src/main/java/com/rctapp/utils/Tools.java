...
public class Tools {
    ...
    public static SSLContext getSLLContext(Context mContext) {
        ...
        try {
            ...
            InputStream certificate = mContext.getAssets().open("rct.crt");
            ...
            e.printStackTrace();
            Log.d("getSLLContext: ", e.getMessage());
        }
        return sslContext;
    }
   ...
   /* public static void displayImageOriginal(Context ctx, ImageView img, @DrawableRes int drawable) {
    ...
    public static void displayImageOriginal(Context ctx, ImageView img, String url) {
        try {
            Glide.with(ctx).load(url).diskCacheStrategy(DiskCacheStrategy.AUTOMATIC).into(img);
        } catch (Exception e) {
            Log.d("displayImageOriginal: ", e.getMessage());
        }
    }
    ...
    public static String getUnixToDate(Long unix) {
    ...
    public static void Mqtt(Context context){
        try {
