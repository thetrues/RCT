...
import com.rct.Auth;
import com.rct.R;
import com.rct.adapter.SellerMultipleSelectAdapter;
import com.rct.database.UserPreference;
import com.rct.databinding.ActivityPlatformBinding;
...
public class PlatformActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding.giveTender.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                GiveTenderMany(sellerIds);
            }
        });
    }
    ...
    public void GiveTender(SellerModel model) {
        ...
        tenderDialog.findViewById(R.id.giveTender).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
